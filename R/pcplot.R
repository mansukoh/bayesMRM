...
#'
#'P0=matrix(c(
#' 0.10, 0.00,  0.0,  0.3, 0.10,  0.2, 0.10,  0.1,  0.1,
#' 0.00, 0.20,  0.1,  0.0, 0.15,  0.1, 0.15,  0.1,  0.2,
#' 0.15, 0.15,  0.2,  0.1, 0.00,  0.0, 0.10,  0.2,  0.1),byrow=TRUE,nrow=3)
#' pcplot(out.Elpaso,P0)
#' pcplot(out.Elpaso,P0,G3D=TRUE)
#' }
